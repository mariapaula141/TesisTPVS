 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		for(java.util.Map.Entry<String, Object> header_tREST_1 : headers_tREST_1.entrySet()) {
			...
			if(builder_tREST_1!=null) {
				restResponse_tREST_1 = builder_tREST_1.post(String.class,"{	  	  \"fecha\": null,          \"mensaje\": \"Error transformado los datos, por favor comuniquese con el administrador.\"      }  ");
			} else {
				restResponse_tREST_1 = restResource_tREST_1.post(String.class,"{	  	  \"fecha\": null,          \"mensaje\": \"Error transformado los datos, por favor comuniquese con el administrador.\"      }  ");
			}
...
/************************************************************************************************
 *     510704 characters generated by Talend Open Studio for Data Integration 
 *     on the 13 de mayo de 2018 12:03:31 AM COT
 ************************************************************************************************/