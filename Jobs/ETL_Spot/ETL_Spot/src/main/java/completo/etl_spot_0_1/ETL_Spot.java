 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */"/home/TPVS/TesisTPVS/media/Spot-fwd.csv"/** End field tFileInputDelimited_1:FILENAME */;		
...
pstmt_tMysqlOutput_1.setNull(18, java.sql.Types.DOUBLE);
            ...
            if(!whetherReject_tMysqlOutput_1) {
                            row9 = new row9Struct();
                                row9.id_operacion = out1Stage.id_operacion;
                                row9.estado = out1Stage.estado;
                                row9.fecha_carga = out1Stage.fecha_carga;
                                row9.fecha_finalizacion = out1Stage.fecha_finalizacion;
                                row9.fecha_insercion = out1Stage.fecha_insercion;
                                row9.fecha_pago = out1Stage.fecha_pago;
                                row9.portafolio_nombre = out1Stage.portafolio_nombre;
                                row9.sistema_nombre = out1Stage.sistema_nombre;
                                row9.cant_contratos = out1Stage.cant_contratos;
                                row9.trader_nombre = out1Stage.trader_nombre;
                                row9.producto_nombre = out1Stage.producto_nombre;
                                row9.tipo_operacion_nombre = out1Stage.tipo_operacion_nombre;
                                row9.moneda1 = out1Stage.moneda1;
                                row9.moneda2 = out1Stage.moneda2;
                                row9.monto_operacion = out1Stage.monto_operacion;
                                row9.contraparte = out1Stage.contraparte;
                                row9.precio = out1Stage.precio;
                                row9.P_L = out1Stage.P_L;
            }
...
class DeleteFoldertFileDelete_1{
    ...
    java.io.File file_tFileDelete_1=new java.io.File("/home/TPVS/TesisTPVS/media/Spot-fwd.csv");
	...
	globalMap.put("tFileDelete_1_DELETE_PATH","/home/TPVS/TesisTPVS/media/Spot-fwd.csv");
...
/************************************************************************************************
 *     365155 characters generated by Talend Open Studio for Data Integration 
 *     on the 12 de mayo de 2018 11:44:15 PM COT
 ************************************************************************************************/